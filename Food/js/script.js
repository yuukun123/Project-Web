...
function search() {
    ...
    for (let key in products) {
        let productArray = products[key];
        filteredProducts = filteredProducts.concat(productArray.filter(product =>
        ...
        productList.innerHTML = filteredProducts.map(product => `
            <div class="tab_content">
                <div class="movie-item">
                    <a href="#"><img class="poster-img" height="300" width="300" src="${product.image}"></a>
